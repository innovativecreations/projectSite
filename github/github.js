...
const link = 'https://github.com/innovativecreations/Airplane/blob/main/README.md'; // Replace this link with the one you want to use
...
getReadmeContent(owner, repo, path)
    .then(response => {
        console.log(`README Content for ${owner}/${repo}:`, response.data);
    })
    .catch(error => {
